...
| `loadBalancerService.enabled`                              | Defines if a Service intended for cluster-external access should be created                                                     | `false`                                  |
| `loadBalancerService.type`                                 | Kubernetes service type                                                                                                          | `LoadBalancer`                           |
| `loadBalancerService.enableBolt`                           | Enable Bolt protocol                                                                                                             | `true`                                   |
| `loadBalancerService.boltPort`                             | Bolt protocol port                                                                                                               | `7687`                                   |
| `loadBalancerService.enableWebsocketMonitoring`            | Enable WebSocket monitoring                                                                                                      | `false`                                  |
| `loadBalancerService.websocketPortMonitoring`              | WebSocket monitoring port                                                                                                        | `7444`                                   |
| `loadBalancerService.enableHttpMonitoring`                 | Enable HTTP monitoring                                                                                                           | `false`                                  |
| `loadBalancerService.httpPortMonitoring`                   | HTTP monitoring port                                                                                                             | `9091`                                   |
| `loadBalancerService.annotations`                          | Annotations to add to the service                                                                                                | `{}`                                     |
| `loadBalancerService.labels`                               | Labels to add to the service                                                                                                     | `{}`                                     |
| `loadBalancerService.externalTrafficPolicy`                | Denotes if this Service desires to route external traffic to node-local or cluster-wide endpoints                                | `null`                                   |
| `loadBalancerService.ipFamilyPolicy`                       | Represents the dual-stack-ness requested or required by this Service                                                             | `null`                                   |
| `loadBalancerService.ipFamilies`                           | List of IP families (e.g. IPv4, IPv6) assigned to this service                                                                   | `null`                                   |
| `loadBalancerService.loadBalancerSourceRanges`             | Restricts traffic through the cloud-provider load-balancer to the specified client IPs. Must be supported by the provider        | `null`                                   |
